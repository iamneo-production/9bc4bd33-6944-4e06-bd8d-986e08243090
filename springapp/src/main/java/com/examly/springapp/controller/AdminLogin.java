...
//    @Autowired
  //  private AdminRepository adminRepository;
   ...
   /* @RequestMapping(value="/adminNameLogin",method=RequestMethod.POST,consumes="application/json",produces="application/json")
    public ResponseEntity<Object> loginNameAdmin(@RequestBody AdminLoginModel admin){
        if (adminService.doesAdminExists(admin))
        return ;
